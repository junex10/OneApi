import { User, PasswordReset, Modules, Person } from "src/models";
...
export declare class AuthService {
    ...
    constructor(userModel: typeof User, passwordResetModel: typeof PasswordReset, moduleModel: typeof Modules, personModel: typeof Person, mailerService: MailerService);
    ...
    updatePassword(request: ResetParams, user: User, password: PasswordReset): Promise<[affectedCount: number]>;
